...
const ProductCard = ({product}) => {
    ...
    return product && (
        <div onClick={()=> {navigate(`/products/${product.category.toLowerCase()}/${product._id}`); scrollTo(0,0)}} className="w-full max-w-[200px] mx-auto border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white">
